...
export function MainHero({ date, address }: Props) {
  ...
  return (
    ...
    `}>
      <div
        className={`
          pointer-events-none absolute top-0 right-0 -z-1
          h-full select-none
        `}
        style={{
      ...
      >
        ...
        <div className="darkreader:hidden">
          <div className={`
            absolute top-0 left-0 size-full bg-black/35
            mix-blend-darken
          `}></div>
          <div className={`
            absolute top-0 left-0 size-full bg-orange-200
            mix-blend-darken
          `}></div>
          <div className={`
            absolute top-0 left-0 size-full bg-rose-200
            mix-blend-darken
          `}></div>
          <div className={`
            absolute top-0 left-0 size-full bg-black/40
            mix-blend-darken
            lg:hidden
          `}></div>
        </div>
        {/* support darkreader extension */}
        <div className="opacity-60 not-darkreader:hidden">
          <div className={`
            absolute top-0 left-0 size-full bg-black/85
            mix-blend-darken
          `}></div>
          <div className={`
            absolute top-0 left-0 size-full bg-orange-200/10
            mix-blend-darken
          `}></div>
          <div className={`
            absolute top-0 left-0 size-full bg-rose-200/10
            mix-blend-darken
          `}></div>
          <div className={`
            absolute top-0 left-0 size-full bg-black/40
      ...
      <div
        className={`
          mr-0 ml-auto flex flex-col items-center
      ...
      >
        <div
          className={cn('relative aspect-square rounded-full shadow-2xl', isSmallHeight && 'hidden')}
        ...
        <div className={`
          ...
          lg:items-baseline
        `}>
          <Image src={Badge} alt="Brasão do casal" height={148} className="mt-4 w-auto drop-shadow-xl lg:-mt-18" />
          ...
          <H4 className="flex flex-col gap-2 font-normal">
            ...
            <a href="#map"className="group flex" onClick={handleAddressClick}>
              ...
              <div>
                ...
                <span className="hidden border-b border-transparent group-hover:border-primary-foreground lg:block">{formatAddress(address, 'full')}</span>
              </div>
            </a>
          </H4>
        </div>
