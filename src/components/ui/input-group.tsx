...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          group/input-group relative flex h-10 w-full
          min-w-0 items-center rounded-none border border-transparent
          ...
          has-[[data-slot=input-group-control]:focus-visible]:border-b-ring
          has-[[data-slot][aria-invalid=true]]:border-b-destructive
...
const inputGroupAddonVariants = cva(
  `
    ...
    gap-2 py-2 text-sm font-medium text-muted-foreground
    select-none
    group-data-[disabled=true]/input-group:opacity-50
    **:data-[slot=kbd]:rounded-none **:data-[slot=kbd]:bg-muted-foreground/10 **:data-[slot=kbd]:px-1.5
  ...
  `,
  {
    variants: {
      align: {
        ...
        'block-start':
          `
            order-first w-full justify-start pt-3
            group-has-[>input]/input-group:pt-3.5
            [.border-b]:pb-3.5
          `,
        'block-end':
          `
            order-last w-full justify-start pb-3
...
const inputGroupButtonVariants = cva(
  `
    flex items-center gap-2 rounded-none text-sm
    shadow-none
  `,
  {
    variants: {
      size: {
        'xs': `
          h-6 gap-1 rounded-none px-1.5 text-xs
          [&>svg:not([class*='size-'])]:size-3.5
        `,
        'sm': '',
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        `
          flex-1 border-0 bg-transparent ring-0
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      ...
      className={cn(
        `
          flex-1 resize-none border-0 bg-transparent py-2.5
          ring-0
          focus-visible:ring-0
          aria-invalid:ring-0
          dark:bg-transparent
