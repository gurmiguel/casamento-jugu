...
const badgeVariants = cva(
  `
    ...
    uppercase items-center justify-center gap-1 overflow-hidden
    rounded-4xl border border-transparent px-2 py-0.5
  ...
  `,
  {
    variants: {
      variant: {
        ...
        success: 'bg-success/20 text-foreground focus-visible:ring-success/20 [a]:hover:bg-success/20',
